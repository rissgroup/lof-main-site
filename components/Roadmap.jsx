...
<Script src="http://ajax.googleapis.com/ajax/libs/jquery/1.7.1/jquery.min.js" type="text/javascript"></Script>
  ...
  <div className="timeline">
    <div className="timeline-item" data-text="FATHER OF THE TURKS">
      <div className="timeline__content"><img className="timeline__img" src="/assets/roadmap/img-1.png"/>
        {/* <h2 className="timeline__content-title">1881</h2> */}
        <p className="timeline__content-desc">A new tokenomics! Designed for investors and content creators. Lower tax for buys, higher tax for sells. Several new features will be implemented to protect loyal investors and ensure LOF price growth over time.
</p>
      </div>
    </div>
    <div className="timeline-item" data-text="FATHER OF THE TURKS">

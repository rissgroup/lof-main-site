...
+(function (root) {
  ...
  pp.init = function (prng) {
    ...
    for (var i = 0; i < 256; i += 1) {
      ...
      this.gradP[i] = this.gradP[i + 256] =
        this.grad3[randval % this.grad3.length];
    }
  };
  ...
  pp.simplex3d = function (x, y, z) {
    ...
    gi1 =
      this.gradP[i + i1 + this.permutation[j + j1 + this.permutation[k + k1]]];
    gi2 =
      this.gradP[i + i2 + this.permutation[j + j2 + this.permutation[k + k2]]];
...
window.addEventListener("load", function () {
  ...
  f1.add(settings, "particleNum", 1000, 15000)
    .step(10)
    .name("Particles")
    .onChange(function () {
  ...
  f2.addColor(settings, "staticColor")
    .name("Static Color")
    .onChange(function () {
      settings.staticColorString =
        "rgba(" +
        Math.floor(settings.staticColor.r) +
        ", " +
        Math.floor(settings.staticColor.g) +
        ", " +
        Math.floor(settings.staticColor.b) +
        ", " +
        0.55 +
        ")";
    });
